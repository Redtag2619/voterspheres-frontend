...
function LeadCard({
  ...
  const leadMailto = buildLeadMailto(lead);
  ...
  return (
    ...
    <div className="lead-card">
      ...
      <ResponsiveRow
        ...
        subtitle={`${getLeadFirm(lead)} • ${leadEmail || "No email"}`}
      ...
      <div className="lead-detail-grid">
        ...
        <div className="lead-detail">
          ...
          {leadMailto ? (
            ...
            <a className="lead-email-link" href={leadMailto}>
            ...
            <strong>No valid email supplied</strong>
      ...
      <div className="lead-actions">
        ...
        {leadMailto ? (
          ...
          <a className="vs-button vs-button-primary" href={leadMailto}>
          ...
          <button type="button" className="vs-button" disabled>
