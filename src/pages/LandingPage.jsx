        ...
        <div className="lp-shell">
          <div className="lp-demo-panel">
            <div className="lp-demo-panel-header">
              ...
              <div className="lp-demo-panel-title">
                ...
                <p>
                  Request a personalized walkthrough and see how VoterSpheres
                  can improve visibility, coordination, and execution across
                  your organization.
                </p>
              </div>
            </div>
            ...
            <div className="lp-demo-panel-body">
              <aside className="lp-demo-overview">
                <div className="lp-demo-overview-copy">
                  <span className="lp-demo-kicker">A walkthrough built around you</span>
                  <h3>See the platform through your operating model.</h3>
                  <p>
                    We will focus the session on the workflows, teams,
                    geography, intelligence signals, and execution challenges
                    that matter most to your organization.
                  </p>
                </div>

                <div className="lp-demo-benefit-list">
                  <div>
                    <i>✓</i>
                  ...
                  <div>
                    <i>✓</i>
                    <span>No obligation or generic sales presentation</span>
                  </div>
                </div>

                <div className="lp-demo-assurance">
                  <span className="lp-demo-assurance-icon">VS</span>
                  <div>
                    <strong>Enterprise-ready conversation</strong>
                    <p>
                      Your information is used only to respond to your request
                      and coordinate the demonstration.
                    </p>
                  </div>
                </div>
              </aside>
              ...
              <form className="lp-demo-form" id="demo-form" onSubmit={handleSubmit}>
                <div className="lp-form-head">
                  <span className="lp-demo-kicker">Request your demo</span>
                  <h3>Tell us about your organization.</h3>
                  <p>
                    We will tailor the walkthrough around your operating model
                    and priorities.
                  </p>
                </div>
                ...
                <p className="lp-form-note">
                  By submitting this form, you agree that VoterSpheres may
                  contact you about the platform. We do not sell your contact
                  information.
                </p>
              </form>
            </div>
