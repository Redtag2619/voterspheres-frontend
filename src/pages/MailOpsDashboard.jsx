...
const L2_DATA_WEBSITE_URL = "https://l2-data.com/";

const L2_DATA_MAPPING_URL = "https://www.l2datamapping.com/";
  ...
  return (
    ...
    >
      ...
      <SectionCard
        ...
        title="L2 Voter Data and Mailing Universe"

        subtitle="Open the official L2 platforms to define voter and consumer audiences, review geographic counts, map a mailing universe, and export approved records for campaign mail production."

        right={<Badge tone="info">External L2 Platform</Badge>}
      ...
      >
        ...
        <div style={{ display: "grid", gap: 14 }}>
          ...
          <div
            ...
            style={{ padding: 16, color: "var(--vs-text-muted)", lineHeight: 1.65 }}

          >

            L2 access remains governed by your organization&apos;s L2 account,

            licensing terms, permitted-use rules, and applicable voter-file and

            consumer-data laws. VoterSpheres opens the official L2 workflow but

            does not transmit MailOps records or credentials to L2 from this page.
          ...
          >
            ...
            <a
              ...
              href={L2_DATA_WEBSITE_URL}

              target="_blank"

              rel="noopener noreferrer"

              aria-label="Open the official L2 Data website in a new tab"
            ...
            <a
              ...
              href={L2_DATA_MAPPING_URL}

              target="_blank"

              rel="noopener noreferrer"

              aria-label="Open the L2 Data Mapping login in a new tab"

            >

              Open L2 Data Mapping
