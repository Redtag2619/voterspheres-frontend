  ...
  async connect({
    ...
    try {
      ...
      dataChannel.onopen = async () => {
        ...
        // Force registration from the backend tools endpoint even though

        // Build 5.8 also embeds tools in the initial session. This makes

        // reconnections deterministic and keeps definitions synchronized.
      ...
      dataChannel.onmessage = async (event) => {
        ...
        const liveToolResult = await this.handleLiveToolsEvent(parsed);
