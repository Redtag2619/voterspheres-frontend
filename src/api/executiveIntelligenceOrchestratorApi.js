 ...
 * Unified Candidate Intelligence Orchestrator API
 ...
 * - Unified Candidate Intelligence payloads

 * - Structured Data Answer normalization

 * - Build 4.4 execution coverage / diagnostics
 ...
 * Build 4.4 structured data normalization
    ...
    candidate:
      ...
      clean(
        ...
        firstDefined(
          ...
          bundle.profile?.primary?.full_name,

          bundle.profile?.primary?.name,
...
export function extractExecutiveDataAnswer(
  ...
  return normalizeDataAnswer(

    firstDefined(

      data.data_answer,

      data.briefing?.data_answer,

      data.data?.data_answer,

      data.data?.briefing?.data_answer,
...
export function extractCandidateIntelligence(
  ...
  const direct =
    ...
    firstDefined(
      ...
      data.data?.candidate_intelligence,
  ...
  if (direct) {
    ...
    return normalizeCandidateIntelligence(
  ...
  const coverage =
    ...
    normalizeCoverage(
      ...
      firstDefined(
        ...
        data.execution?.coverage,

        data.data?.coverage,

        data.data?.execution?.coverage,
  ...
  const confidence =
    ...
    clamp(
      ...
      firstDefined(
        ...
        data.execution?.confidence,

        data.data?.execution?.confidence,
...
function normalizeRequest(
  ...
  return {
    ...
    include_candidate_intelligence:

      data.include_candidate_intelligence !== false,

 

    include_data_answer:

      data.include_data_answer !== false,
 ...
 * Build 4.4 page-compatible method.
