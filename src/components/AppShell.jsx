        ...
        <div className="vs-modal-backdrop">
          <div className="vs-modal-card">
            <div className="vs-modal-head">
              <div>
                <div className="vs-modal-eyebrow">New Client Workspace</div>
                <h3 className="vs-modal-title">Create Workspace</h3>
            ...
            {createError ? <div className="vs-modal-error">{createError}</div> : null}

            <form className="vs-modal-form" onSubmit={handleCreateWorkspace}>
              ...
              <div className="vs-modal-actions">
                ...
                <button type="submit" className="vs-button" disabled={creating}>
