export const navigationSections = [
  {
    ...
    items: [
      ...
      { label: "Polling Intelligence", to: "/executive-polling-intelligence", description: "Live VoteHub polling, trends, averages, and pollster intelligence."},
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Campaign Studio AI", to: "/campaign-operations-studio" },
